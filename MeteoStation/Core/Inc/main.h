...
extern TaskHandle_t handle_rtc_task, handle_bme280_task, handle_lcd_task, handle_sd_task, handle_esp32_send;
extern QueueHandle_t q_bme280, q_lcd, q_sd, q_esp32;
extern SemaphoreHandle_t i2cMutex, spiMutex;
